 ...
 */
#define USE_CONTROLLER_FAN // 230606_E3NG_RH3D
  ...
  #define CONTROLLERFAN_SPEED_ACTIVE    153 // (0-255) Active speed, used when any motor is enabled // 230627_E3NG_RH3D
  #define CONTROLLERFAN_SPEED_IDLE       51 // (0-255) Idle speed, used when motors are disabled // 230627_E3NG_RH3D
 ...
 */
//#define FAN_MIN_PWM 50 // 230606_E3NG_RH3D
//#define FAN_MAX_PWM 128 // 230606_E3NG_RH3D
...
/**
 * M355 Case Light on-off / brightness // 230606_E3NG_RH3D
 */
...
//#define SENSORLESS_BACKOFF_MM  { 2, 2, 0 }  // (linear=mm, rotational=°) Backoff from endstops before sensorless homing // 230606_E3NG_RH3D
 ...
 */
//#define Z_STEPPER_AUTO_ALIGN // 230606_E3NG_RH3D
 ...
 */
#define INPUT_SHAPING_X // 230614_E3NG_RH3D
#define INPUT_SHAPING_Y // 230614_E3NG_RH3D
#if EITHER(INPUT_SHAPING_X, INPUT_SHAPING_Y)
  #if ENABLED(INPUT_SHAPING_X)
    #define SHAPING_FREQ_X  52.3        // 230627_E3NG_RH3D // (Hz) The default dominant resonant frequency on the X axis.
    #define SHAPING_ZETA_X  0.05f       // 230627_E3NG_RH3D // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  52.3        // 230627_E3NG_RH3D // (Hz) The default dominant resonant frequency on the Y axis.
    #define SHAPING_ZETA_Y  0.05f       // 230627_E3NG_RH3D // Damping ratio of the Y axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  //#define SHAPING_MIN_FREQ  20        // By default the minimum of the shaping frequencies. Override to affect SRAM usage.
  //#define SHAPING_MAX_STEPRATE 10000  // By default the maximum total step rate of the shaped axes. Override to affect SRAM usage.
  #define SHAPING_MENU                // Add a menu to the LCD to set shaping parameters. // 230614_E3NG_RH3D
#endif
 ...
 */
#define DEFAULT_STEPPER_DEACTIVE_TIME 240 // 230606_E3NG_RH3D
 ...
 */
//#define ADAPTIVE_STEP_SMOOTHING // 230606_E3NG_RH3D
...
#define MICROSTEP_MODES { 16, 16, 16, 16, 16, 16 } // [1,2,4,8,16] // 230606_E3NG_RH3D
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 4*60, 2*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel // 230606_E3NG_RH3D
...
#define ENCODER_RATE_MULTIPLIER
  ...
  #define ENCODER_10X_STEPS_PER_SEC   30  // (steps/s) Encoder rate for 10x speed // 230606_E3NG_RH3D
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  //#define PROBE_OFFSET_WIZARD       // Add a Probe Z Offset calibration option to the LCD menu
    ...
    // Show Deploy / Stow Probe options in the Motion menu. // 230606_E3NG_RH3D
  ...
  //#define LCD_TIMEOUT_TO_STATUS 15000   // (ms)
    ...
    #define BOOTSCREEN_TIMEOUT 4000       // (ms) Total Duration to display the boot screen(s) // 230606_E3NG_RH3D
   ...
   */
  //#define LED_CONTROL_MENU // 230606_E3NG_RH3D
...
#define SET_PROGRESS_MANUALLY
  ...
  #define SET_REMAINING_TIME            // Add 'R' parameter to set remaining time, otherwise use Marlin's estimate // 230606_E3NG_RH3D
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define SHOW_REMAINING_TIME           // Display estimated time to completion (prefix 'R') // 230606_E3NG_RH3D
  ...
  //#define SDCARD_READONLY                   // Read-only SD card (to save over 2K of flash) // 230606_E3NG_RH3D
  ...
  //#define SDCARD_RATHERRECENTFIRST // 230606_E3NG_RH3D
   ...
   * point in the file.
   */
  #define POWER_LOSS_RECOVERY // 230606_E3NG_RH3D
   ...
   */
  #define SDCARD_SORT_ALPHA // 230606_E3NG_RH3D
   ...
   */
  //#define CONFIGURATION_EMBEDDING // 230606_E3NG_RH3D
  ...
  //#define NO_SD_DETECT // 230606_E3NG_RH3D
 ...
 */
  ...
  //#define XYZ_NO_FRAME // 230606_E3NG_RH3D
  #define XYZ_HOLLOW_FRAME // 230606_E3NG_RH3D
  ...
  // Western only. Not available for Cyrillic, Kana, Turkish, Greek, or Chinese.
  //#define USE_SMALL_INFOFONT // 230606_E3NG_RH3D
  ...
  //#define STATUS_HEAT_PERCENT       // Show heating in a progress bar // 230606_E3NG_RH3D
  //#define BOOT_MARLIN_LOGO_ANIMATED // Animated Marlin logo. Costs ~3260 (or ~940) bytes of flash. // 230606_E3NG_RH3D
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_WITHOUT_HOMING // 230606_E3NG_RH3D
  //#define BABYSTEP_ALWAYS_AVAILABLE       // Allow babystepping at all times (not just during movement).
  //#define BABYSTEP_XY                     // Also enable X/Y Babystepping. Not supported on DELTA!
  #define BABYSTEP_INVERT_Z false           // Change if Z babysteps should go the other way // 230606_E3NG_RH3D
  #define BABYSTEP_MILLIMETER_UNITS       // Specify BABYSTEP_MULTIPLICATOR_(XY|Z) in mm instead of micro-steps // 230606_E3NG_RH3D
  ...
  #define BABYSTEP_DISPLAY_TOTAL          // Display total babysteps since last G28 // 230606_E3NG_RH3D

  #define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping // 230627_E3NG_RH3D
 ...
 */
#define LIN_ADVANCE // 230606_E3NG_RH3D
  ...
  //#define ALLOW_LOW_EJERK       // Allow a DEFAULT_EJERK value of <10. Recommended for direct drive hotends. // 230606_E3NG_RH3D
...
// G2/G3 Arc Support
//
#define ARC_SUPPORT                 // Requires ~3226 bytes // 230606_E3NG_RH3D
 ...
 */
#define FWRETRACT // 230614_E3NG_RH3D
  ...
  #endif
  #define RETRACT_LENGTH              3.2   // (mm) Default retract length (positive value) // 230627_E3NG_RH3D - BOWDEN EXTRUDER
  #define RETRACT_LENGTH_SWAP          13   // (mm) Default swap retract length (positive value)
  #define RETRACT_FEEDRATE             40   // (mm/s) Default feedrate for retracting // 230627_E3NG_RH3D
 ...
 */
   ...
   */
  #if HAS_STEALTHCHOP
    //#define STEALTHCHOP_XY // 230713_E3NG_RH3D
    ...
    //#define STEALTHCHOP_E  // 230713_E3NG_RH3D
  #endif
